...
//   .Router()
//   .get('/', (req, res) => {
//     //gets curent video and how far into video currently are
//     var now = new Date()
//     var day = now.getDay()
...
//     var progress =
//       convertTimeToMin(day, hour, min, sec) -
//       convertTimeToMin(dayStart, hourStart, minStart, 0)
...
//         console.log()
//         var prom = ffprobe(`./public/videos/${vid.name}`, {
